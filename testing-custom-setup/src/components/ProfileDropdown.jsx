      ...
      <div className="absolute right-0 top-full mt-2 w-64 rounded-lg bg-white dark:bg-surface-800 shadow-lg ring-1 ring-surface-200 dark:ring-surface-700 z-50">
        <div className="p-4 border-b border-surface-200 dark:border-surface-700">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 onClick={handleClickYourChannel} className="font-medium text-surface-800 dark:text-surface-100">{userData?.fullName?userData.fullName:"Guest"}</h3>
              <p className="text-sm text-surface-500 dark:text-surface-400">@{userData?.username?userData.username: "guest"}</p>
            </div>
          </div>
        </div>
        <div className="py-2">
